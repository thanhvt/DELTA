...
import { urlApiGetTotalTasks } from '../global';

var dateFormat = require('dateformat');

class TotalTask extends Component {
    ...
    loadInitialState = async () => {
        ...
        var date = dateFormat(currentDate, 'dd-mm-yyyy');
        ...
        fetch(urlApiGetTotalTasks(companyId, date))
            .then((res) => {
                if (res.ok) {
                    return res.json();
                } else {
